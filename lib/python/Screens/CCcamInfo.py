...
# Update CCcam Info By RAED support Full HD Skin (1920x1080) 29-06-2015
...
def CCcamListEntry(name, idx):
        ...
        if fileExists(png):
           ...
           width = size.width()
           if width == 1920:
                res.append(MultiContentEntryPixmapAlphaTest(pos=(0, 6), size=(35, 25), png=loadPNG(png)))
                res.append(MultiContentEntryText(pos=(40, 3), size=(500, 35), font=0, text=name))
           else:
...
def CCcamShareListEntry(hostname, type, caid, system, uphops, maxdown):
        ...
        width = size.width()
        if width == 1920:
                res.append(MultiContentEntryText(pos=(0, 0), size=(250, 35), font=0, text=hostname))
                res.append(MultiContentEntryText(pos=(250, 0), size=(250, 35), font=0, text=_("Type: ")+type, flags=RT_HALIGN_RIGHT))
                res.append(MultiContentEntryText(pos=(0, 20), size=(250, 35), font=0, text=_("CaID: ")+caid))
                res.append(MultiContentEntryText(pos=(250, 20), size=(250, 35), font=0, text=_("System: ")+system, flags=RT_HALIGN_RIGHT))
                res.append(MultiContentEntryText(pos=(0, 40), size=(250, 35), font=0, text=_("Uphops: ")+uphops))
                res.append(MultiContentEntryText(pos=(250, 40), size=(250, 35), font=0, text=_("Maxdown: ")+maxdown, flags=RT_HALIGN_RIGHT))
        else:
...
def CCcamShareViewListEntry(caidprovider, providername, numberofcards, numberofreshare):
        ...
        if width == 1920:
                ...
                res.append(MultiContentEntryText(pos=(0, 0), size=(430, 35), font=0, text=providername))
                res.append(MultiContentEntryText(pos=(430, 0), size=(50, 35), font=0, text=numberofcards, flags=RT_HALIGN_RIGHT))
                res.append(MultiContentEntryText(pos=(480, 0), size=(50, 35), font=0, text=numberofreshare, flags=RT_HALIGN_RIGHT))
        else:
                res = [(caidprovider, providername, numberofcards)]
...
if width == 1280:
        ...
        CCcamInfoMain_SKIN = """
        <screen position="center,center" size="800,650" title="CCcam Info">
                <widget name="menu" position="0,0" size="800,650" scrollbarMode="showOnDemand" />
        </screen>"""
else:
        CCcamInfoMain_SKIN = """
        <screen position="center,center" size="500,420" title="CCcam Info" >
